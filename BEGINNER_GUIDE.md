...
当前正式版本是
[`v0.4.13`](https://github.com/yoyicue/xpad2-cli/releases/tag/v0.4.13)。只需要下载：

```text
xpad2-v0.4.13-android-arm64
```

macOS 或 Linux 可以直接执行：

```sh
curl -fLO https://github.com/yoyicue/xpad2-cli/releases/download/v0.4.13/xpad2-v0.4.13-android-arm64
shasum -a 256 xpad2-v0.4.13-android-arm64
```

Windows PowerShell 可以执行：

```powershell
Invoke-WebRequest -Uri "https://github.com/yoyicue/xpad2-cli/releases/download/v0.4.13/xpad2-v0.4.13-android-arm64" -OutFile "xpad2-v0.4.13-android-arm64"
Get-FileHash .\xpad2-v0.4.13-android-arm64 -Algorithm SHA256
```
...
```sh
adb push xpad2-v0.4.13-android-arm64 /data/local/tmp/xpad2
...
```text
xpad2 0.4.13 (catalog 2026-07-16.14)
```
...
如果当前仍是 v0.1.x，需要先按第 3–4 节手工覆盖到当前 v0.4.13 一次；旧版本没有
自更新命令。
